...
# Relative path — place your dataset in a "data/Train" folder next to this script
data_dir = "data/Train"
...
# Save the trained model so main6.py can load it
model.save("models/my_model.h5")
print("Model saved to models/my_model.h5")
